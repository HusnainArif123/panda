...
const signup = () => {
  ...
  return (
    <div className="flex-col flex items-center justify-center h-screen  bg-blue-100">
      <h1 className="text-blue-900 text-3xl font-bold">Sign Up Now!</h1>
      <div className="flex-col flex px-5  mt-6">
        ...
        >
          SignUp <CheckmarkIcon />
        </button>
        <Link
          className="text-blue-900 mx-15 items-center justify-center ite mt-2 font-bold"
          href={"/login"}
        >
          Visit Login Page
        </Link>
